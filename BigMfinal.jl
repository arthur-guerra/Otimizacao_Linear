...
using PrettyTables
    ...
    ###############################################################################################
        ...
        #Ajuste do vetor sinal, para mudança dos sinais de desigualdade  
            ...
            Solução_Dual = (tableau[1,(n_linhas-1:colun_tableau-1)])

            #println(Solução_Dual)
            ...
            pretty_table(Solução_Dual, row_names = variavel_dual, header = ["Valor"], border_crayon = crayon"yellow",formatters = ft_round(2))
